...
const char * ssid_sta     = "Obernburg1";
const char * password_sta = "Sabine.Obernburg";
...
void make_HTML01() {
  ...
  strcat( HTML_String, "<td><input type=\"time\"   style= \"width:150px\" name=\"UHRZEIT\" value=\"");
  ...
  strcat( HTML_String, "<td><input type=\"date\"  style= \"width:150px\" name=\"DATUM\" value=\"");
